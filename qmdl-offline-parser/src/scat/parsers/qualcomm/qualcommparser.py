...
class QualcommParser:
    def __init__(self):
        ...
        # Initialize enhanced parser for structured data extraction
        try:
            from scat.parsers.enhanced_qualcomm_parser import EnhancedQualcommParser
            self.enhanced_parser = EnhancedQualcommParser(self)
            self.use_enhanced_parsing = True
            self.logger.log(logging.INFO, 'Enhanced parsing enabled for structured data extraction')
        except ImportError:
            self.enhanced_parser = None
            self.use_enhanced_parsing = False
            self.logger.log(logging.WARNING, 'Enhanced parsing not available')
